<template>
  ...
  >
    ...
    >
      ...
      <div
        class="px-3 py-1 flex items-center bg-[#F1F1F2] p-1 rounded-full max-w-[380px] w-full"
      >
        <input
          type="text"
      ...
      >
        ...
        <div class="flex items-center">
          ...
          />
          <div class="relative">
            <button class="mt-1" @click="($event) => (showMenue = !showMenue)">
              <img
                class="rounded-full"
                width="33"
